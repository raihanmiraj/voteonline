    ...
    return (
        <div className='max-w-[1600px] mx-auto md:px-12 px-5'>
            ...
            <animated.div style={springProps} className="animated-element">
                <div className='md:text-6xl text-4xl font-semibold text-gray-600 text-center md:my-10 mb-5 my-font'>Where Can You Use Voteonline?</div>
            </animated.div>

            <animated.div style={springProps2} className="animated-element"> 
            <p className='text-gray-400 text-center mb-16 w-[80%] mx-auto md:text-xl text-lg'>Voteonline is the trusted choice for world-class organizations with industry-specific voting needs. Our platform is tailored to meet the unique voting requirements of top-tier entities across various sectors, providing efficiency, security, and valuable insights for informed decision-making. Join the ranks of organizations that have chosen Voteonline to elevate their voting processes.</p>
            </animated.div>
